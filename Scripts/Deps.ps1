...
# SOME PACKAGES WAS INSTALLED VIA-WINUTIL
...
# install Nitro PDF
winget install --id NitroSoftware.NitroPro --silent --accept-package-agreements --accept-source-agreements

# install character map UWP
winget install --id 9WZDNCRDXF41 --silent --accept-package-agreements --accept-source-agreements

# install Notion
winget install --id Notion.Notion --silent --accept-package-agreements --accept-source-agreements

# install Notion Calendar
winget install --id Notion.NotionCalendar --silent --accept-package-agreements --accept-source-agreements
